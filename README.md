...
#### Research Question
What are you trying to answer? How an accurate ML model can be build to predict future stock price(s)
...
#### Methodology
What methods are you using to answer the question? In this project I have been using various techniques to estimate future stock prices:
1-	Decision Tree: I used historical closing price data as an input feature as well as target variable for SVM modelling after splitting the data (90% training & 10 testing).
2-	Support vector machine: I used historical closing price data as an input feature as well as target variable for SVM modelling after splitting the data (90% training & 10 testing)
3-	Time series analysis such as S/ARIMA (Seasonal/ARIMA) that combines autoregression (AR), differencing (I), and moving average (MA) as well as handling seasonal patterns 
